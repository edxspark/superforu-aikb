...
public class SysDictDataServiceImpl implements ISysDictDataService {
     ...
     */
    @Override
    public List<SysDictDataVo> selectDictDataList(List<Long> dictCodes) {
        return baseMapper.selectVoList(new LambdaQueryWrapper<SysDictData>().in(CollUtil.isNotEmpty(dictCodes),SysDictData::getDictCode,dictCodes));
    }
    ...
    public Map<String,String> selectDictDataMap(String dictType) {
        List<SysDictDataVo> sysDictDataVos = baseMapper.selectDictDataByType(dictType);
        Map<String, String> collect = sysDictDataVos.stream()
